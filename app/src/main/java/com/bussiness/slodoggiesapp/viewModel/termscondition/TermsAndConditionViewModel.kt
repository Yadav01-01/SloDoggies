package com.bussiness.slodoggiesapp.viewModel.termscondition
...
class TermsAndConditionViewModel @Inject constructor(
    ...
    fun termsConditionRequest(onSuccess: () -> Unit = { }, onError: (String) -> Unit) {
        viewModelScope.launch {
            repository.termsConditionRequest().collectLatest { result ->
                when (result) {
                    is Resource.Loading -> {
