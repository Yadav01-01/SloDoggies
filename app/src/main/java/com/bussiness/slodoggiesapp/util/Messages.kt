...
object Messages {
    ...
    const val BUDGET = "Please select a budget"
    const val CAT_SMS = "Select at least one category"
    const val TERM_CON = "Please enter terms & conditions."
    ...
    const val  EXPIRE_DATE= "Please select expiry date."
    const val EXPIRE_TIME= "Please select expiry time."
